                    ...
                    try {
                        ...
                        if (index != -1) {
                           ...
                           //System.out.println(min+  "분 " + ", "+ sec +"초" );
                            ...
                            System.out.println("arrive Name: " + arriveloc);

                            System.out.println("start x location : " + arr_start_x);
                            System.out.println("start x location : " + arr_start_y);

                            System.out.println("stop x location : " + arr_stop_x);
                            System.out.println("stop y location : " + arr_stop_y);
*/
                        // xfound x좌표, yfound y좌표 다음 액티비티로 값 전달
                            ...
                            intent.putExtra("arrive_name", arriveloc);
                            intent.putExtra("start_number",startnum);
                            intent.putExtra("stop_number",stopnum);
